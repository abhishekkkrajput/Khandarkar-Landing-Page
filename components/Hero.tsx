        ...
        <div className="animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            ...
            <a
              ...
              className="group relative flex items-center gap-5 px-10 py-5 rounded-[2.5rem] gold-gradient shadow-[0_20px_50px_rgba(212,175,55,0.4)] transition-all hover:scale-105 active:scale-95 border-2 border-white/20"
            >
              <img
