        ...
        <section id="cta" className="relative py-40 flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                    ...
                    <button className="group relative flex items-center gap-5 px-10 py-5 rounded-[2.5rem] gold-gradient shadow-[0_20px_60px_rgba(212,175,55,0.4)] transition-all hover:scale-105 active:scale-95 border-2 border-white/20">
                      <img 
